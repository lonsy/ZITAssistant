...
public class DailyDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater infalter, ViewGroup container, 
		...
		{
			RelativeLayout.LayoutParams p = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, 0);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {  
        switch (menuItem.getItemId()) {  
        	...
        	case R.id.ic_edit:
        		...
        		//编辑时隐藏提交，使用右上角的提交按钮
    			RelativeLayout.LayoutParams p = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, 0);
    			((RelativeLayout)this.getActivity().findViewById(R.id.daily_editor_bottom_layout)).setLayoutParams(p);
